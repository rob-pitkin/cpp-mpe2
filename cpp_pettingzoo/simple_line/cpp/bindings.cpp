...
PYBIND11_MODULE(_simple_line, m) {
  ...
  pybind11::class_<cpp_pettingzoo::simple_line::SimpleLineEnv>(
      m, "SimpleLineEnv")
      ...
      .def("get_agents",
           &cpp_pettingzoo::simple_line::SimpleLineEnv::get_agents)
      .def("get_state",
           &cpp_pettingzoo::simple_line::SimpleLineEnv::get_state)
      .def("get_render_state",
           &cpp_pettingzoo::simple_line::SimpleLineEnv::get_render_state)
      .def(
          "reset",
          [](cpp_pettingzoo::simple_line::SimpleLineEnv& self,
