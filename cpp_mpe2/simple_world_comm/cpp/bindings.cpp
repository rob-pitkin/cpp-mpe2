...
PYBIND11_MODULE(_simple_world_comm, m) {
  ...
  pybind11::class_<cpp_mpe2::simple_world_comm::SimpleWorldCommEnv>(
      ...
      .def("get_agents",
           &cpp_mpe2::simple_world_comm::SimpleWorldCommEnv::get_agents)
      .def("get_state",
           &cpp_mpe2::simple_world_comm::SimpleWorldCommEnv::get_state)
      .def("get_render_state",
           &cpp_mpe2::simple_world_comm::SimpleWorldCommEnv::
               get_render_state)
      .def(
          "reset",
          [](cpp_mpe2::simple_world_comm::SimpleWorldCommEnv& self,
