...
PYBIND11_MODULE(_simple_adversary, m) {
  ...
  pybind11::class_<cpp_mpe2::simple_adversary::SimpleAdversaryEnv>(
      ...
      .def("get_agents",
           &cpp_mpe2::simple_adversary::SimpleAdversaryEnv::get_agents)
      .def("get_state",
           &cpp_mpe2::simple_adversary::SimpleAdversaryEnv::get_state)
      .def("get_render_state", &cpp_mpe2::simple_adversary::
                                   SimpleAdversaryEnv::get_render_state)
      .def(
          "reset",
          [](cpp_mpe2::simple_adversary::SimpleAdversaryEnv& self,
