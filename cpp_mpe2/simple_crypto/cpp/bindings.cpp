...
PYBIND11_MODULE(_simple_crypto, m) {
  ...
  pybind11::class_<cpp_mpe2::simple_crypto::SimpleCryptoEnv>(
      m, "SimpleCryptoEnv")
      ...
      .def("get_agents",
           &cpp_mpe2::simple_crypto::SimpleCryptoEnv::get_agents)
      .def("get_state",
           &cpp_mpe2::simple_crypto::SimpleCryptoEnv::get_state)
      .def("get_render_state",
           &cpp_mpe2::simple_crypto::SimpleCryptoEnv::get_render_state)
      .def(
          "reset",
          [](cpp_mpe2::simple_crypto::SimpleCryptoEnv& self,
