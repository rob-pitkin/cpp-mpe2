...
PYBIND11_MODULE(_simple_tag, m) {
  ...
  pybind11::class_<cpp_mpe2::simple_tag::SimpleTagEnv>(m, "SimpleTagEnv")
      ...
      .def("get_agents",
           &cpp_mpe2::simple_tag::SimpleTagEnv::get_agents)
      .def("get_state",
           &cpp_mpe2::simple_tag::SimpleTagEnv::get_state)
      .def("get_render_state",
           &cpp_mpe2::simple_tag::SimpleTagEnv::get_render_state)
      .def("get_curriculum_stage",
           &cpp_mpe2::simple_tag::SimpleTagEnv::get_curriculum_stage)
      .def("advance_curriculum",
           &cpp_mpe2::simple_tag::SimpleTagEnv::advance_curriculum)
      .def("set_curriculum_stage",
           &cpp_mpe2::simple_tag::SimpleTagEnv::set_curriculum_stage)
      .def(
          "reset",
          [](cpp_mpe2::simple_tag::SimpleTagEnv& self,
