"""Benchmark C++ vs Python PettingZoo SimpleLine environments."""
...
from cpp_mpe2.simple_line.simple_line import parallel_env as cpp_parallel_env
...
if __name__ == "__main__":
    ...
    mpe2_factory = lambda: simple_line_v1.parallel_env(N=N, max_cycles=MAX_CYCLES)
