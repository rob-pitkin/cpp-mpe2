...
PYBIND11_MODULE(_simple_spread, m) {
  ...
  pybind11::class_<cpp_mpe2::simple_spread::SimpleSpreadEnv>(
      m, "SimpleSpreadEnv")
      ...
      .def("get_agents",
           &cpp_mpe2::simple_spread::SimpleSpreadEnv::get_agents)
      .def("get_state",
           &cpp_mpe2::simple_spread::SimpleSpreadEnv::get_state)
      .def("get_render_state",
           &cpp_mpe2::simple_spread::SimpleSpreadEnv::get_render_state)
      .def(
          "reset",
          [](cpp_mpe2::simple_spread::SimpleSpreadEnv& self,
      ...
      .def(
          ...
          &cpp_mpe2::simple_spread::SimpleSpreadEnv::get_curriculum_stage)
      .def("advance_curriculum",
           &cpp_mpe2::simple_spread::SimpleSpreadEnv::advance_curriculum)
      .def("set_curriculum_stage", &cpp_mpe2::simple_spread::
