...
PYBIND11_MODULE(_simple_reference, m) {
  ...
  pybind11::class_<cpp_mpe2::simple_reference::SimpleReferenceEnv>(
      ...
      .def("get_agents",
           &cpp_mpe2::simple_reference::SimpleReferenceEnv::get_agents)
      .def("get_state",
           &cpp_mpe2::simple_reference::SimpleReferenceEnv::get_state)
      .def("get_render_state", &cpp_mpe2::simple_reference::
                                   SimpleReferenceEnv::get_render_state)
      .def(
          "reset",
          [](cpp_mpe2::simple_reference::SimpleReferenceEnv& self,
