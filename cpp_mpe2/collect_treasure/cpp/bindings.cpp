...
PYBIND11_MODULE(_collect_treasure, m) {
  ...
  pybind11::class_<cpp_mpe2::collect_treasure::CollectTreasureEnv>(
      ...
      .def("get_agents",
           &cpp_mpe2::collect_treasure::CollectTreasureEnv::get_agents)
      .def("get_state",
           &cpp_mpe2::collect_treasure::CollectTreasureEnv::get_state)
      .def("get_render_state",
           &cpp_mpe2::collect_treasure::CollectTreasureEnv::get_render_state)
      .def(
          "reset",
          [](cpp_mpe2::collect_treasure::CollectTreasureEnv& self,
