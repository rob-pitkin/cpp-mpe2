...
PYBIND11_MODULE(_simple_formation, m) {
  ...
  pybind11::class_<cpp_mpe2::simple_formation::SimpleFormationEnv>(
      ...
      .def("get_agents",
           &cpp_mpe2::simple_formation::SimpleFormationEnv::get_agents)
      .def("get_state",
           &cpp_mpe2::simple_formation::SimpleFormationEnv::get_state)
      .def("get_render_state",
           &cpp_mpe2::simple_formation::SimpleFormationEnv::get_render_state)
      .def(
          "reset",
          [](cpp_mpe2::simple_formation::SimpleFormationEnv& self,
