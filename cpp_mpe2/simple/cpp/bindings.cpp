...
PYBIND11_MODULE(_simple_core, m) {
  ...
  pybind11::class_<cpp_mpe2::simple::SimpleEnv>(m, "SimpleEnv")
      ...
      .def("get_agents", &cpp_mpe2::simple::SimpleEnv::get_agents)
      .def("get_state", &cpp_mpe2::simple::SimpleEnv::get_state)
      .def("get_render_state", &cpp_mpe2::simple::SimpleEnv::get_render_state)
      .def(
          "reset",
          [](cpp_mpe2::simple::SimpleEnv &self, std::optional<int> seed) {
      ...
      .def("step", [](cpp_mpe2::simple::SimpleEnv &self,
