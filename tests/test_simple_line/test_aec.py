"""Test SimpleLine AEC API compatibility."""
...
from cpp_pettingzoo.simple_line.simple_line import env as line_env


def test_aec_api():
    aec_api_test(line_env(N=4), num_cycles=10, verbose_progress=False)
